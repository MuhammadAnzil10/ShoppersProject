const productAddFom = document
  .querySelector('[id="productAddFom"]')
  .addEventListener("submit", (e) => {
    ...
    const ProductRegularPriceErr = document.getElementById(
      "ProductRegularPriceErr"
    );
    const ProductStockQuantityErr = document.getElementById(
      "ProductStockQuantityErr"
    );
    ...
    document.querySelector('[id="productAddFom"]').submit();
  });
